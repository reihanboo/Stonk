        ...
        @auth
            <li class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-bs-toggle="dropdown" href="#" role="button"
                    aria-haspopup="false" aria-expanded="false">
                    <span class="nav-user-name hidden-sm mr-4">{{ Auth::user()->name }} </span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item text-sm text-gray-700 dark:text-gray-500 underline" href="{{ url('/dashboard') }}"><i data-feather="user" class="align-self-center icon-xs icon-dual me-1"></i> Dashboard</a>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="dropdown-item underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
                            <i data-feather="power" class="align-self-center icon-xs icon-dual me-1"></i> {{ __('Log Out') }}
                        </button>
                    </form>
                </div>
            </li>
        @else
            <a href="{{ route('login') }}" class="underline nav-link waves-effect waves-light">Log in</a>

            @if (Route::has('register'))
                <a href="{{ route('register') }}" class="nav-link waves-effect waves-light">Register</a>
            @endif
        @endauth
        @endif
